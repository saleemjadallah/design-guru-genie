...
export const PricingSection = () => {
  return (
    <>
      ...
      <WaveDivider fillColor="#ffffff" height={40} className="my-0" />
      
      <section className="py-12 bg-gradient-to-br from-purple-50 via-white to-indigo-50 rounded-2xl relative mt-4 overflow-hidden">
